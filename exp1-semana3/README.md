...
| Sitio publicado (GitHub Pages) | https://ign14.github.io/DF1_ExpSumativas/exp1-semana3/ |
...
├── entrega/
│   ├── Ignacio_PFY2201_*.html/.css   # Copias con el nombre exigido por el AVA
...
| 6. Verificación en navegadores (15 pts) | Probado en los tres motores de render: Blink (Chrome/Edge/Opera), Gecko (Firefox) y WebKit (Safari), en anchos de 320 a 1920 px; sin prefijos propietarios ni propiedades experimentales | `entrega/capturas/navegadores/` |
| 7. Publicación en GitHub con capturas (10 pts) | Repositorio con HTML, CSS, imágenes y capturas; despliegue en rama `gh-pages` | Este README y `entrega/capturas/` |
...
|---|---|---|
| ![Móvil](entrega/capturas/movil-375x812-inicio.png) | ![Tablet](entrega/capturas/tablet-768x1024-inicio.png) | ![Escritorio](entrega/capturas/escritorio-1440x900-inicio.png) |

Las versiones de página completa están en `entrega/capturas/` (la de móvil, por su altura,
va dividida en `-parte1` y `-parte2`). En `entrega/capturas/navegadores/` está la comparación
...
cd DF1_ExpSumativas/exp1-semana3
